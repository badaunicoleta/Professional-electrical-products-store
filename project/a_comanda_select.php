...
<html>
	...
	<body>
			...
			<form method="post" action="a_comanda_newInfo.php">
				...
				<?php
					...
					echo"<h3> 1. Select the order name </h3>";
				
					// retrieve nr_comanda, data and id_client from database
					...
					if(mysqli_num_rows($sql)){
						...
						while($rs = mysqli_fetch_array($sql)){
							...
							.$rs['nr_comanda']. ' '. $rs['data'].' '.$rs['id_client'].'</option>';
						}
